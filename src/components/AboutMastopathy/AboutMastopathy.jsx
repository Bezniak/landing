                ...
                <div className="container mx-auto p-6">
                    ...
                    <section className="my-12">
                        ...
                        <p className="mt-4 text-gray-700">
                            ...
                            эстрогенов и
                            прогестерона могут привести к увеличению ткани молочной железы и развитию фиброзных
                            изменений.
                        </p>
                    </section>
                    ...
                    <motion.section
                        ...
                        transition={{duration: 1.5}}
                    >
                        <h2 className="text-2xl font-semibold text-gray-800">Как лечить мастопатию: эффективные
                            методы</h2>
                        <p className="mt-4 text-gray-700">
