...
const InfoCard = ({imageSrc, text}) => (
    <div
        className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 w-full md:w-80 h-96">
            ...
            <div className="container mx-auto p-6">
                ...
                <section className="my-12">
                    ...
                    <p className="mt-4 text-gray-700">
                        Фиброзно-кистозная мастопатия – это заболевание молочной железы, при котором в ткани груди
                        развиваются доброкачественные изменения.
                        Эти изменения могут быть как единичными, так и множественными, и включают фиброзные ткани и
                        кисты. Чаще всего заболевание встречается у женщин репродуктивного возраста.
                    </p>
                </section>
                ...
                <section className="my-12">
                    ...
                    <p className="mt-4 text-gray-700">
                        Гормональные изменения играют важную роль в развитии мастопатии. Нарушения в уровне эстрогенов и
                        прогестерона могут привести к увеличению ткани молочной железы и развитию фиброзных изменений.
                    </p>
                </section>

                <h2 className="text-2xl mb-10 font-semibold text-gray-800">Симптомы мастопатии: на что обратить
                    внимание</h2>
                <div className="flex items-center justify-center gap-10 flex-wrap">
                ...
                >
                    <h2 className="text-2xl font-semibold text-gray-800">Диагностика мастопатии: как выявить
                        заболевание</h2>
                    <p className="mt-4 text-gray-700">
                        Диагностика мастопатии включает в себя несколько методов: ультразвуковое исследование,
                        маммография, а также пальпация молочных желез врачом. Иногда могут быть проведены дополнительные
                ...
                <motion.section
                    ...
                    transition={{duration: 1.5}}
                >
                    <h2 className="text-2xl font-semibold text-gray-800">Антиоксиданты при мастопатии: роль в
                        профилактике</h2>
                    <p className="mt-4 text-gray-700">
                        Антиоксиданты играют важную роль в профилактике и лечении мастопатии, так как они помогают
                        снизить воспаление и улучшить общее состояние организма. Включение антиоксидантных продуктов в
                        рацион может помочь предотвратить развитие заболевания.
                    </p>
                </motion.section>
            </div>
        </div>
