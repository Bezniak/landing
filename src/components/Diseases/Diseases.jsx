            ...
            <div className='container mx-auto pt-20'>
                ...
                <div className='flex flex-wrap justify-center'>
                    <motion.div
                        ...
                        viewport={{once: false}}
                    >
                        <img src="/lycomat_4.png" alt="Частые заболевания и нарушения"/>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        viewport={{once: false}}
                    >
                        <img src="/lycomat_5.png" alt="Мастопатия (фиброзно-кистозная болезнь)"/>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        viewport={{once: false}}
                    >
                        <img src="/lycomat_5.png" alt="Фиброаденомы"/>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        viewport={{once: false}}
                    >
                        <img src="/lycomat_7.png" alt="Злокачественные опухоли (рак молочной железы)"/>
                    </motion.div>
                </div>
                <p className='py-5'>
