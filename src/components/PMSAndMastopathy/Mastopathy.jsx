...
const Mastopathy = () => {
    ...
    return (
        <div>
            ...
            >
                <h2 className="text-2xl text-center md:w-1/2 font-semibold mb-4">
            ...
            <div className="">
                ...
                >
                    <h2 className="text-2xl text-center md:w-full font-semibold mb-4">
                ...
                >
                    <div className='container mx-auto text-center py-10'>
                        <p className="text-lg mb-5 font-semibold">Интересный факт:</p>
                        <p className="text-lg leading-relaxed">
