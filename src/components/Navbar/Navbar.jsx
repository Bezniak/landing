...
const Navbar = () => {
    ...
    return (
        <nav className="absolute z-50 top-0 left-1/2 transform -translate-x-1/2 bg-[var(--bg-navbar)] border-gray-200 w-full">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                >
                    <ul className="flex flex-col font-medium p-4 md:p-0 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
                        <li>
                            <NavLink  to={ROUTES.BREAST_HEALTH}
                        ...
                        <li>
                            <NavLink to={ROUTES.PMS_MASTOPATHY}
                                     onClick={() => setIsMobileMenuOpen(false)}
                                     className="block py-2 px-3 rounded md:border-0 md:p-0 text-black transition">
                                ПМС и мастопатия
                            </NavLink>
                        ...
                        <li>
                            <NavLink to={ROUTES.ABOUT_MASTOPATHY}
                                     onClick={() => setIsMobileMenuOpen(false)}
                                     className="block py-2 px-3 rounded md:border-0 md:p-0 text-black transition">
                                О мастопатии
                            </NavLink>
                        ...
                        <li>
                            <NavLink to={ROUTES.ULTRASOUND_DIAGNOSTICS}
                                     onClick={() => setIsMobileMenuOpen(false)}
                                     className="block py-2 px-3 rounded md:border-0 md:p-0 text-black transition">
                                Диагностика УЗИ
                            </NavLink>
                        ...
                        <li>
                            <NavLink to={ROUTES.SURVEY_FOR_CONSULTATION}
                                     onClick={() => setIsMobileMenuOpen(false)}
                                     className="block py-2 px-3 rounded md:border-0 md:p-0 text-black transition">
